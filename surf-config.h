...
static Key keys[] = {
    ...
    { MODKEY|GDK_SHIFT_MASK, GDK_KEY_h,      spawn,      SETURI("_SURF_GO") },
	...
	{ MODKEY|GDK_SHIFT_MASK, GDK_KEY_z,      zoom,       { .i = -1 } },
...
static SearchEngine searchengines[] = {
    ...
    { "w", "http://wikiwand.com/en/%s" },
    { "wn", "http://wordnetweb.princeton.edu/perl/webwn?s=%s" },
...
// https://en.wikipedia.org/wiki/index.php/Special:Search?search=${s}&go=Go
// https://en.wikipedia.org/wiki/index.php/Special:Search?search=${s}&go=Go
// https://en.wiktionary.org/w/index.php?search=${s}&go=Go
